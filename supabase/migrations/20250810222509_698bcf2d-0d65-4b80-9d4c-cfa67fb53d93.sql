...
CREATE POLICY IF NOT EXISTS "Anyone can view face recognition logs"
ON public.face_recognition_logs FOR SELECT USING (true);
CREATE POLICY IF NOT EXISTS "Anyone can insert face recognition logs"
...
CREATE POLICY IF NOT EXISTS "Anyone can view biometric photos"
ON public.user_biometric_photos FOR SELECT USING (true);
CREATE POLICY IF NOT EXISTS "Anyone can insert biometric photos"
ON public.user_biometric_photos FOR INSERT WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "Anyone can update biometric photos"
...
CREATE POLICY IF NOT EXISTS "Anyone can view punch records"
ON public.punch_records FOR SELECT USING (true);
CREATE POLICY IF NOT EXISTS "Anyone can insert punch records"
...
CREATE POLICY IF NOT EXISTS "Face images are publicly accessible"
ON storage.objects FOR SELECT
USING (bucket_id = 'face-recognition');

CREATE POLICY IF NOT EXISTS "Anyone can upload face images"
ON storage.objects FOR INSERT
WITH CHECK (bucket_id = 'face-recognition');

CREATE POLICY IF NOT EXISTS "Anyone can update face images"
